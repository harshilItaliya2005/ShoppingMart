...
class ElectronicsAdapter( private var products: List<ProductData>): RecyclerView.Adapter<ElectronicsAdapter.ElectronicsViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ElectronicsViewHolder {
    ...
    fun updateData(newProducts: List<ProductData>) {
        products = newProducts.filter { it.category == "electronics" }
        notifyDataSetChanged()
    }

    inner class ElectronicsViewHolder(val binding: ItemProductBinding) :
